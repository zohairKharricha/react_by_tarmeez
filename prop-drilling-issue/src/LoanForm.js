  ...
  return (
    ...
    >
      <form id="loan-form" className="flex" style={{flexDirection: "column"}}>
        ...
        <MyComponent
          inputNameComponent="Name:"
          handleChangeComponent={handleNameChange}
          valueComponent={loanInputs.name}
        />

        <MyComponent
          inputNameComponent="Phone Number:"
          handleChangeComponent={handlePhoneNumberChange}
          valueComponent={loanInputs.phoneNumber}
        />

        <MyComponent
          inputNameComponent="Age:"
          handleChangeComponent={handleAgeChange}
